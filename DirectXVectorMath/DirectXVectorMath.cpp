...
{
	Menu();
	// Using constructor D3DXVECTOR3(FLOAT x, FLOAT y, FLOAT z), define a vector V1=(1,2,3);
        D3DXVECTOR3 V1;
		V1=D3DXVECTOR3(1.0F,2.0F,3.0F);
	...
	D3DXVec3Scale(&c, &V1, 10.0F);

	//  compute the length or norm of  V1 , ||V1|| , using D3DXVec3Length()
	float length;
	length = D3DXVec3Length(&V1);
	 
	//  compute the normalized vector of V1 that d = u / ||u|| using D3DXVec3Normalize()
	...
	//  compute the cross product of  V1 and V2  that is e = V1 x V2 using D3DXVec3Cross()
